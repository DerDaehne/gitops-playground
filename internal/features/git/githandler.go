...
import (
	...
	"github.com/DerDaehne/gitops-playground/internal/features/git/gitlab"
	"github.com/DerDaehne/gitops-playground/internal/features/git/provider"
	"github.com/DerDaehne/gitops-playground/internal/features/git/scmmanager"
)
...
func (g *GitHandler) Validate() error {
	...
	if g.Config.SCM.Gitlab.Url != "" {
		g.Config.SCM.SCMProvider = feature.GITLAB
		g.Config.SCM.SCMManager = feature.SCMManagerTenantConfig{}
