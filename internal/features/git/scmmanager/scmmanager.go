...
type ScmManager struct {
	...
	scmmConfig *feature.SCMManagerTenantConfig
	appConfig  *config.ApplicationConfig
}

func NewScmManager(globalConfig *config.Config, scmmConfig *feature.SCMManagerTenantConfig, installNeeded bool) (*ScmManager, error) {
	sm := &ScmManager{
