...
import (
	...
	"github.com/DerDaehne/gitops-playground/internal/features/git/scmmanager/api"
	"github.com/DerDaehne/gitops-playground/internal/helm"
)

func SetupHelm(scmmConfig *feature.SCMManagerTenantConfig) error {
...
func Configure(apiClient *api.ScmManagerApiClient, appConfig *config.ApplicationConfig, scmmConfig *feature.SCMManagerTenantConfig, jenkinsConfig *config.JenkinsConfig, scmmUrl string) error {
...
func installScmmPlugins(apiClient *api.ScmManagerApiClient, scmmConfig *feature.SCMManagerTenantConfig, jenkinsConfig *config.JenkinsConfig) error {
...
func addDefaultUsers(apiClient *api.ScmManagerApiClient, appConfig *config.ApplicationConfig, scmmConfig *feature.SCMManagerTenantConfig) error {
