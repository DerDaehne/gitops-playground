...
type ScmManagerUrlResolver struct {
	...
	scmm      *gitconfig.SCMManagerTenantConfig
}

func NewScmManagerUrlResolver(appConfig *config.ApplicationConfig, scmm *gitconfig.SCMManagerTenantConfig) *ScmManagerUrlResolver {
